        ...
        <section class="p-4 sm:ml-64 ">
            ...
            <form  id="qr-form" method="post" action="process_qr.php">
                ...
                <div class="flex items-center justify-center m-10">
                    <div class="relative">
                        <select name="dropdownSession"
                            ...
                            <option value="<?php echo $session['session_title']; ?>"><?php echo $session['session_title']; ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                        <div
                            ...
                            <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path
                                    d="M14.293 5.293a1 1 0 011.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414L10 8.586l4.293-4.293z" />
                            </svg>
                        </div>
                    </div>
                </div>
                        ...
                        elseif($success == 2) {
                            ...
                            <div class="flex justify-center mb-4">
                                <div class="w-1/2  h-20 flex items-center justify-center mb-6 bg-transparent border-2 border-red-800 font-medium rounded-lg text-2xl px-3 py-1.5 text-center dark:text-red-400">
                                    ...
                                    <span class="text-red-800">Already Scanned</span>
                                </div>
                            </div>';
                        }
                    }
                ...
                <?php
                    ...
                    if (isset($_GET['participants_id'])) {
                        $participants_id = $_GET['participants_id'];

                        // Query to fetch participant's full name from the database
                        $sql = "SELECT full_name FROM participants WHERE participants_id = '$participants_id'";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo '<div class="flex justify-center mb-4">';
                            echo '<div class="w-1/2 h-20 flex items-center justify-center mb-6 bg-transparent border-2 border-blue-800 font-medium rounded-lg text-2xl px-3 py-1.5 text-center dark:text-blue-400">';
                            echo '<span class="text-blue-800">Participant Not Found</span>';
                            echo '</div>';
                            echo '</div>';
                        }
                    }
